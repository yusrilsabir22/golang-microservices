...
type LogisticServiceClient interface {
	...
	FindOne(ctx context.Context, in *FindOneLogisticRequest, opts ...grpc.CallOption) (*FindOnLogisticResponse, error)
}
...
func (c *logisticServiceClient) FindOne(ctx context.Context, in *FindOneLogisticRequest, opts ...grpc.CallOption) (*FindOnLogisticResponse, error) {
	out := new(FindOnLogisticResponse)
...
type LogisticServiceServer interface {
	...
	FindOne(context.Context, *FindOneLogisticRequest) (*FindOnLogisticResponse, error)
...
func (UnimplementedLogisticServiceServer) FindOne(context.Context, *FindOneLogisticRequest) (*FindOnLogisticResponse, error) {
...
func _LogisticService_FindOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogisticServiceServer).FindOne(ctx, req.(*FindOneLogisticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
